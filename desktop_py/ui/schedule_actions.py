...
def apply_auto_fetch_push_schedule(window: Any) -> None:
...
def apply_auto_renew_schedule(window: Any, *, min_auto_renew_interval_ms: int, max_auto_renew_interval_ms: int) -> None:
...
def run_auto_renew(window: Any, *, renew_account_state_fn: Any, close_all_group_runtimes_fn: Any = None) -> None:
